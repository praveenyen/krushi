-- Fix get_balance_summaries function return type issue
-- This migration drops and recreates the function with the correct signature
...
-- Also fix the get_person_balance function if it exists
