...
-- Run this in your Supabase SQL Editor to resolve the function return type issue

-- Drop existing functions to avoid conflicts
DROP FUNCTION IF EXISTS get_balance_summaries();
DROP FUNCTION IF EXISTS get_person_balance(UUID);

-- Recreate get_balance_summaries function with correct signature
...
-- Recreate get_person_balance function with correct signature
